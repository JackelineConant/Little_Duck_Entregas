...
_lr_productions = [
  ...
  ('cte -> CONST_FLOAT','cte',1,'p_cte_float','parser.py',842),
  ('cte -> CONST_STRING','cte',1,'p_cte_str','parser.py',853),
  ('func -> VOID ID ( ID : type funcs_ayuda ) func_start [ vars body ] ;','func',14,'p_funcs_params','parser.py',866),
  ('func -> VOID ID ( ) func_start [ vars body ] ;','func',10,'p_funcs_empty_params','parser.py',888),
  ('func -> VOID ID ( ID : type funcs_ayuda ) func_start [ body ] ;','func',13,'p_funcs_params_no_vars','parser.py',908),
  ('func -> VOID ID ( ) func_start [ body ] ;','func',9,'p_funcs_empty_params_no_vars','parser.py',930),
  ('func_start -> <empty>','func_start',0,'p_func_start','parser.py',948),
  ('funcs_list -> funcs_list func','funcs_list',2,'p_funcs_list','parser.py',955),
  ('funcs_list -> func','funcs_list',1,'p_funcs_list_single','parser.py',959),
  ('funcs_list -> empty','funcs_list',1,'p_funcs_list_empty','parser.py',963),
  ('funcs_ayuda -> , ID : type funcs_ayuda','funcs_ayuda',5,'p_funcs_ayuda','parser.py',967),
  ('funcs_ayuda -> empty','funcs_ayuda',1,'p_funcs_ayuda_empty','parser.py',972),
  ('program -> PROGRAM ID ; vars funcs_list MAIN inicio_main body END','program',9,'p_program','parser.py',978),
  ('inicio_main -> <empty>','inicio_main',0,'p_inicio_main','parser.py',990),
]
