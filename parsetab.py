...
_lr_productions = [
  ...
  ('type -> INT','type',1,'p_type_int','parser.py',24),
  ('type -> FLOAT','type',1,'p_type_float','parser.py',28),
  ...
  ('print -> PRINT ( CONST_STRING print_ayuda ) ;','print',6,'p_print_string','parser.py',137),
